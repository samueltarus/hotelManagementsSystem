                ...
                <div class="col-xl-4 col-lg-5 offset-xl-2 offset-lg-1">
                    ...
                    <form action="{{url('save-booking')}}"  method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            <label for="customer_id">National ID:</label>
                            <input type="text" class="form-control" placeholder="Enter National ID" name="customer_id" id="customer_id" required>
                          </div>
                            ...
                            <div class="select-option">
                                ...
                                <select id="guest" name="guest" required>
                                    ...
                                    <option >11 Children</option>
                                    <option >12 Children</option>
                                    <option >13 Children</option>
